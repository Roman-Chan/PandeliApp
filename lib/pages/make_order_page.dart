...
class MakeOrderPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer2<DesignsProvider, OrdersProvider>(
        builder: (context, designsProvider, orderProvider, child) {
          return RefreshIndicator(
            onRefresh: () => designsProvider.fetchDesigns(),
            child: Column(
              ...
              children: [
                ...
                designsProvider.isLoading
                    ...
                    : designsProvider.designs!.isEmpty
                        ? const Center(child: Text("No hay diseños"))
                        : Expanded(
                            child: GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return OptionCardTest(
                                  ...
                                  active: orderProvider.design?.id == design.id,
                                  onTapHandler: () {
